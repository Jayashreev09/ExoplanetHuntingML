# -*- coding: utf-8 -*-
"""
Created on Fri Jun  4 18:37:31 2021
...
test_data = pd.read_csv('C:/Users/Rovane/Downloads/exoTest.csv').fillna(0)
train_data = pd.read_csv('C:/Users/Rovane/Downloads/exoTrain (1).csv').fillna(0)
...
model(gb_classifier,x_train_res,y_train_res,x_test,y_test)

from sklearn.linear_model import LogisticRegression 
lr_classifier = LogisticRegression()
print("----------LOGISTIC REGRESSION-------------")
model(lr_classifier,x_train_res,y_train_res,x_test,y_test)

from xgboost import XGBClassifier
xgb_classifier = XGBClassifier(eval_metric='logloss')
print("----------XGBOOST-------------")
model(xgb_classifier,x_train_res,y_train_res,x_test,y_test)

from lightgbm import LGBMClassifier
lgbm_classifier = LGBMClassifier()
print("--------LGBM----------")
model(lgbm_classifier,x_train_res,y_train_res,x_test,y_test)

from catboost import CatBoostClassifier
cat_classifier = CatBoostClassifier(verbose=0)
print("---------CATBOOST---------")
model(cat_classifier,x_train_res,y_train_res,x_test,y_test)
